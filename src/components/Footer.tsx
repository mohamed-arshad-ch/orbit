            ...
            <div className="container mx-auto px-6">
                <div className="grid md:grid-cols-4 gap-10 mb-10">
                    <div className="col-span-1 md:col-span-2">
                        <h3 className="text-2xl font-bold bg-gradient-to-r from-white to-sky-400 bg-clip-text text-transparent mb-4">Orbita Group Of Companies</h3>
                ...
                <div className="border-t border-white/10 pt-8 text-center text-slate-600 text-sm">
                    <p>&copy; {new Date().getFullYear()} Orbita Group Of Companies All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
